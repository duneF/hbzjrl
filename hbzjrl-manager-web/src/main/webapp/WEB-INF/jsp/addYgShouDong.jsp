...
<div class="add">
  <form action="/addYgShouDong" method="post">
    <table class="table table-hover">
      ...
      <tr>
        <td>姓名</td>
        <td><input id="name" name="name" placeholder="手机号"/></td>
      </tr>
      <tr>
        <td>身份证号</td>
      ...
      <tr>
        <td>住址</td>
        <td><input id="address" name="address" placeholder="手机号"/></td>
      </tr>
      <tr>
        <td>手机</td>
      ...
      <tr>
        <td>企业</td>
        <td><input id="factory" name="factory" placeholder="输入渠道"/></td>
      </tr>
      <tr>
        <td>合同日期</td>
        <td>
          <select  class="form-select" id="sel1" name="workTime">
            <option name="workTime" value="长期">长期</option>
            <option name="workTime" value="1个月">1个月</option>
            <option name="workTime" value="2个月">2个月</option>
            <option name="workTime" selected="selected" value="3个月">3个月</option>
            <option name="workTime" value="6个月">6个月</option>
            <option name="workTime" value="15天">15天</option>
          </select>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td>员工备注</td>
        <td><input id="wokerRemarks" name="wokerRemarks" value="没有其他事项"/></td>
      </tr>
      <tr>
        <td>代理</td>
      ...
      <tr>
        <td>代理单价</td>
        <td><input id="whosePrice" name="whosePrice" placeholder="代理单价/总利润"/></td>
      </tr>
      <tr>
        <td>代理备注</td>
        <td><input id="whoseRemarks" name="whoseRemarks" value="没有其他事项"/></td>
      </tr>
      <tr>
        <td>总价</td>
